...
function initialization() {
	...
	{ [[ -f "$DIR/../style.rasi" ]] && RASI_DIR="$DIR/../style.rasi"; } || { [[ -f "${XDG_CONFIG_HOME:-$HOME/.config}/rofi/config/style.rasi" ]] && RASI_DIR="${XDG_CONFIG_HOME:-$HOME/.config}/rofi/config/style.rasi"; } || exit
